...
export function RecipeEditor({ polishId, initialLines, onCancel, onSaved }: RecipeEditorProps) {
    ...
    <div className="space-y-4">
            ...
            >
              <div>
                ...
                <input
                  ...
                  className="w-full border border-ink/20 rounded-lg px-3 py-2 min-h-[44px] text-sm focus:outline-none focus:ring-2 focus:ring-teal/40 focus:border-teal"
                  placeholder="Name"
                />
              </div>
              <div>
      ...
      <div className="flex flex-wrap gap-2 pt-1">
        ...
        <button
          ...
          onClick={save}
          disabled={pending}
          className="px-4 py-2 min-h-[44px] text-sm bg-teal text-white rounded-lg hover:opacity-90 disabled:opacity-50 transition-opacity"
        >
